    ...
    <div class="font-poppins absolute top-0 min-h-screen max-w-screen min-w-screen bg-indigo-50 flex items-start justify-center flex-col overflow-x-hidden">
        <div class="container-xl w-full mt-24 bg-indigo-50 flex items-start justify-center">
            <div class="container-xl h-auto w-96 flex items-start justify-start flex-col">
                <h1 class="text-5xl drop-shadow">Login Cuy</h1>
                <p class="text-1xl pr-10 pt-5">
                    Ayo, waktunya mengungkap perjalanan akademikmu! Masukkan akun kamu untuk membuka pintu ke dunia rekapitulasi nilai mahasiswa. Di sini, kamu bisa melihat hasil perjuanganmu, memantau langkah-langkah sukses, dan merencanakan strategi untuk mencapai puncak.
                    <br>
                    Setiap nilai adalah cerita, setiap ujian adalah tantangan, dan setiap pencapaian adalah kemenangan. Jangan biarkan dirimu terlewatkan.
                    <br>
                    Apakah kamu siap untuk melangkah lebih jauh?
                </p>
            </div>
            <div class="container-xl h-auto w-96 flex items-center justify-center bg-indigo-100 shadow-lg">
                <form action="<?php echo site_url('auth/proses_login')?>" method="post" class="w-full h-full bg-indigo-100 p-7 rounded-lg container-lg">
                    <div class="w-full flex flex-col mb-4">
                        <label for="name">Username or Email</label>
                        <input type="text" name="usem" id="name" placeholder="Masukkan Username atau Email" class="rounded-md w-full px-4 py-2" require>
                    </div>
                    <div class="w-full flex flex-col mb-4">
                    ...
                    <div class="w-full h-auto flex flex-col justify-center mt-4">
                        ...
                        <button  type="submit" class="w-full h-auto bg-indigo-700 rounded-lg py-2 text-indigo-50 mt-2">Login</button>
                    </div>
                </form>
            </div>
        </div>
